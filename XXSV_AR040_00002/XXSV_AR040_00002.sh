...
#|                                                                          |
#| HISTORY                                                                  |
#|    16-10-2014  Carlos Torres  Created   Entrustca                        |
#+==========================================================================*/
...
echo '       Starting installation process for patch XXSV_AR040_00002       '
echo
...
sqlplus apps/$APPS_PASS @$XBOL_TOP/patch/XXSV_AR040_00002/xbol/sql/apps_grants.sql
echo '------------------------------------------------------------'
echo 'Compiling XXSV_AR_REV_UTL.pks'
sqlplus bolinf/$BOLINF_PASS @$XBOL_TOP/patch/XXSV_AR040_00002/xbol/sql/XXSV_AR_REV_UTL.pks
echo '------------------------------------------------------------'
echo 'Compiling XXSV_AR_REV_UTL.pkb'
sqlplus bolinf/$BOLINF_PASS @$XBOL_TOP/patch/XXSV_AR040_00002/xbol/sql/XXSV_AR_REV_UTL.pkb
echo '------------------------------------------------------------'
echo 'Creating View XXSV_GL_JE_AR_TRX_CUST_REPORT.sql'
sqlplus bolinf/$BOLINF_PASS @$XBOL_TOP/patch/XXSV_AR040_00002/xbol/sql/XXSV_GL_JE_AR_TRX_CUST_REPORT.sql
echo '------------------------------------------------------------'
echo 'Running bolinf_grant.sql'
sqlplus bolinf/$BOLINF_PASS @$XBOL_TOP/patch/XXSV_AR040_00002/xbol/sql/bolinf_grant.sql
echo '------------------------------------------------------------'
echo 'Running apps_synonyms.sql'
sqlplus apps/$APPS_PASS @$XBOL_TOP/patch/XXSV_AR040_00002/xbol/sql/apps_synonyms.sql
echo '------------------------------------------------------------'
...
FNDLOAD apps/$APPS_PASS 0 Y UPLOAD $FND_TOP/patch/115/import/afcpprog.lct $XBOL_TOP/patch/XXSV_AR040_00002/xbol/admin/import/C_XXSVARDRILLREV.ldt CUSTOM_MODE="FORCE"
echo '------------------------------------------------------------'
echo 'Request Group R_Receivables_All.ldt'
FNDLOAD apps/$APPS_PASS 0 Y UPLOAD $FND_TOP/patch/115/import/afcpreqg.lct $XBOL_TOP/patch/XXSV_AR040_00002/xxbol/admin/import/R_Receivables_All.ldt CUSTOM_MODE="FORCE"
echo '------------------------------------------------------------'
...
echo 'DATA_TEMPLATE XXSVARDRILLREV.rtf '
FNDLOAD apps/$APPS_PASS 0 Y UPLOAD $XDO_TOP/patch/115/import/xdotmpl.lct T_XXSVARDRILLREV.ldt CUSTOM_MODE=FORCE
...
echo '------------------------------------------------------------'
echo ' '
echo 'TEMPLATE_SOURCE XXSVARDRILLREV.rtf '
